...
public class BookController {
    ...
    {
    "id": 1,
    "title": "The classic Tale of java",
    "author": "Daniel Dipietrantonio",
    "price": 699.69
    }
    */
    //
    ...
    // GET http://localhost:8082/api/books/paged?page=0&size=5
...
//        }
    ...
    // http://localhost:8082/api/books/advanced?title=java&minPrice=10&maxPrice=50&sortBy=price&order=desc&page=1&size=3
    ...
    public List <Book> getBooksAdvanced(
        ...
        switch(sortBy.toLowerCase()) {
            case "author":
                ...
                case "price":
                        ...
                        default: comparator = Comparator.comparing(Book::getTitle);
                        break;
        }
        if("desc".equalsIgnoreCase(order)) {
            comparator = comparator.reversed();
        ...
        //Pagination
        return filteredBooks.subList(page, size);
    }
